Me lo analizas y me dices si está fallando o en dnd está fallando la idea es tener un maratona Ubuntu es una imagen de Linux modificado con programas pre instalados 
#!/bin/bash
set -euo pipefail
